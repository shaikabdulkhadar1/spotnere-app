/**
 * UpcomingBookingsScreen — Shows upcoming bookings from Profile
 * Uses TripCard, filters for future dates + paid/success status
 */
...
const UpcomingBookingsScreen = ({ onTripPress, onBack }) => {
    ...
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        contentContainerStyle={
          upcoming.length === 0 ? styles.scrollContentCentered : styles.scrollContent
        }
          ...
          {upcoming.length === 0 ? (
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyTitle}>
                {hasUser ? "No upcoming bookings" : "Log in to see your bookings"}
              </Text>
              <Text style={styles.emptyText}>
                {hasUser
                  ? "Your upcoming trips will appear here"
                  : "Sign in to view your upcoming bookings"}
              </Text>
              {hasUser && (
